...
export const CSV_HEADER_LABELS: Record<string, string> = {
  ...
  sscSeatPrefix: "10th Seat Prefix (A/B/C/S/P)",
  sscSeatNumber: "10th Seat Number",
  board10th: "10th Board",
  percentage10th: "10th Percentage",
  year10th: "10th Year",
  hscSeatPrefix: "12th Seat Prefix (A/B/C/S/P)",
  hscSeatNumber: "12th Seat Number",
  ...
  idCardValidUpto: "ID Card Valid Upto (DD/MM/YYYY)",
  firstNameGu: "First Name (Gujarati)",
  middleNameGu: "Middle Name (Gujarati)",
  surnameGu: "Surname (Gujarati)",
  aadhaarNameGu: "Aadhaar Name (Gujarati)",
  motherNameGu: "Mother Name (Gujarati)",
  fatherNameGu: "Father Name (Gujarati)",
  guardianNameGu: "Guardian Name (Gujarati)",
};
