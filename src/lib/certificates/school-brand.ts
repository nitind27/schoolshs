...
export const CERTIFICATE_PACK_BRANDS: Record<string, CertificateSchoolBrand> = {
  ...
  "24261004403": {
    ...
    nameEnAlt: "Shri Sarvajanik High School Fort-Songadh",
    nameGu: "શ્રી સાર્વજનિક હાઈસ્કૂલ ફોર્ટ-સોનગઢ",
    address: "Navagam, Fort-Songadh, Dist. Tapi. Pin-394670",
    addressGu: "નવાગામ, ફોર્ટ-સોનગઢ, જિ. તાપી. પિન-૩૯૪૬૭૦",
    sscIndex: "—",
    hscIndex: "—",
    diseCode: "24261004403",
    phone: "222186",
    ...SHARED_LABELS,
    section: "( GRANTED / NON GRANTED) PRIMARI SECTION",
  },
  "24261004404": {
    nameEn: "SHRI SARVAJANIK HIGH SCHOOL",
    nameEnAlt: "Shri Sarvajanik High School Fort-Songadh",
