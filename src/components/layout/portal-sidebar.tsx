...
export function PortalLayout({
  ...
  return (
    <div className={cn("min-h-screen", shellClassName || "bg-gradient-to-br from-slate-100 via-sky-50/30 to-slate-100")}>
      <TopNavbar profileHref={profileHref} showProfile={showProfile} sidebarWidth={260} />
      {children}
    </div>
  );
}
  ...
  return (
    <>
      ...
      >
        ...
        <nav className="min-h-0 flex-1 overflow-y-auto px-3 py-3 space-y-1">
        ...
        {footerExtra && (
          <div className="shrink-0 p-3" style={{ borderTop: "1px solid rgba(255,255,255,.08)" }}>
            {footerExtra}
          </div>
        )}
      </aside>
