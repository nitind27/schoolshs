...
export function BilingualNameField({
  ...
  return (
    <div className="grid min-w-0 grid-cols-1 gap-3 rounded-xl border border-slate-200 bg-gradient-to-br from-slate-50/80 to-white p-3 shadow-sm [&>*]:min-w-0 sm:grid-cols-2">
      <Input
        id={enId}
